...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ascend MiniMind Pretraining")
    ...
    parser.add_argument("--wandb_project", type=str, default="Ascend-MiniMind-Pretrain")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Ascend-MiniMind-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
