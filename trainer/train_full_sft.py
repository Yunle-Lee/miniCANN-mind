...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ascend MiniMind Full SFT")
    ...
    parser.add_argument("--wandb_project", type=str, default="Ascend-MiniMind-Full-SFT")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Ascend-MiniMind-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
